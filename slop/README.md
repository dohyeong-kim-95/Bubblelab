...
| `picklock/` | 자물쇠 러시 (타이밍 탭 스코어 어택) | 점수 최대 |
...
`picklock`은 도는 바늘이 금색 구간에 들어온 순간 탭하는 스코어 어택입니다.
구간 중심부를 맞추면 PERFECT로 콤보 배수(최대 ×8)가 쌓이고, 핀을 다 따면
자물쇠 해제 보너스 후 더 빠르고 좁은 다음 자물쇠가 나옵니다. 한 번 빗나가면
종료. puzzle의 스테이지제 자물쇠 따기를 스코어제로 개편해 승격한 게임입니다.
