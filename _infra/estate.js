...
// 화성시는 일반구 설치로 옛 통합 코드 41590이 폐지됐고 과거 월 데이터까지
// 새 구 코드로 이관됐다 (2026-07 API 실측: 41590은 전 기간 0건, 동탄은
// 41597에서 동탄1 법정동까지 전부 조회됨. 나머지 화성 구는 41591·41593·41595).
export const REGIONS = new Map([
  ["dongtan", { lawd: "41597", label: "화성시 동탄구" }], // 동탄1·2 신도시
