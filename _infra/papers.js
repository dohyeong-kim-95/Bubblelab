...
읽어볼 만하다고 판단되면 이렇게, **어디서 하는 것인지 분명히** 알려주세요:
   PC 의 Claude Code 에서  /paper <번호>
그 명령은 디스코드 명령이 아니라 PC 에서 도는 것입니다. 디스코드에 치면 아무 일도
일어나지 않으니, 어디서 하는 것인지 빼고 이름만 알려주면 안 됩니다.
